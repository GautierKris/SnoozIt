...
/**
 * Class IdToAdvertInterestTransformer
 * @package Snoozit\PlatformBundle\Form\Transformer
 */
class IdToAdvertInterestTransformer implements DataTransformerInterface
{
    /**
     * @var ObjectManager
     */
    ...
    public function reverseTransform($name)
    {
        ...
        $id = $this->om
                ->getRepository('SnoozitPlatformBundle:AdvertInterest')
                ->find($name);
