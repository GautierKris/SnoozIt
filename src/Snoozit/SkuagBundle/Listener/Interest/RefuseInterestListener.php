...
class RefuseInterestListener
{
    ...
    {
        $type = $this->entityManager->getRepository('SnoozitPlatformBundle:NotificationType')->find(5);
    ...
    public function processRefuseInterest(InterestEvent $event)
    {
        // Le propriétaire
        $userLog = new UserLog();
        $userLog
    ...
    private function sendMessage(InterestEvent $event)
    {
        ...
        $message = new \Swift_Message("Désolé, c'est un refus!",

            $templating->render('SnoozitSkuagBundle:Mail/Interest:RefuseMail.html.twig',
                array(
