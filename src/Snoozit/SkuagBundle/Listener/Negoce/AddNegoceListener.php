...
class AddNegoceListener
{
    ...
    {
        $type = $this->entityManager->getRepository('SnoozitPlatformBundle:NotificationType')->find(3);
    ...
    private function sendMessage(NegoceEvent $event)
    {
        ...
        $message = new \Swift_Message("Vous avez reçu une offre!",

            $templating->render('SnoozitSkuagBundle:Mail/Negoce:NegoceMail.html.twig',
                array(
